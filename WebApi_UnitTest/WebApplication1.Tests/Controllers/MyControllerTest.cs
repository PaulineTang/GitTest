...
namespace WebApplication1.Tests.Controllers
{
    ...
    public class MyControllerTest
    {
        ...
        public void ShouldSetResponseHeaderWhenPostForNewIssue()
        {
            ...
            Xunit.Assert.Equal(response.Headers.Location.AbsoluteUri, "http://tyz.com/My/1");
        ...
        public void ShouldSupportAtomType()
        {
            ...
            Xunit.Assert.True((formatter.Object).SupportedMediaTypes.Any(i => i.MediaType == "application/atom+xml"));
